...
public class CalculadoraEstadisticas
{
	...
	/**
	 *Función 14 calculadora*/
	
	public String PaisQueRepresenta(String nombrePersona) 
	{
		String resultado = null;
		Atleta elAtleta = buscarAtleta(nombrePersona);
		if (elAtleta != null)
		{
			Pais respuesta = elAtleta.darPais();
			resultado = respuesta.darNombre();
		}
