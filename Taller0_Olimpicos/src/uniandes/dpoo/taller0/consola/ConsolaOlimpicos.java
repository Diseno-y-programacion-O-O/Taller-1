...
public class ConsolaOlimpicos
{
	...
	/**
	 * Consola función 14 para conocer el pais que representa el atleta
	 */
	private void ejecutarNombreAtletaPorPais()
	{
		System.out.println("\n" + "País que representa un atleta" + "\n");

		String atleta = input("Por favor ingrese el nombre de un atleta");
		String pais = calculadora.PaisQueRepresenta(atleta);
		if (pais == null)
		{
		...
		{
				System.out.println(atleta + " representa a " + pais);
		}
	}
